  ...
  return (
    <div className={styles.page}>
      ...
      <SplitSection
        ...
        imageSrc="/images/provider-dashboard.png"
        imageOnLeft={true}
      ...
      <SplitSection
        ...
        imageSrc="/images/mobile-rehab.png"
        imageOnLeft={true}
      ...
      <section className={styles.finalCta}>
        ...
        <p>
          In a recent 6-week study, patients using mRehab improved motor control by <strong>30%</strong> and adherence by <strong>25%</strong> compared to traditional home exercise programs.
          With real-time data, AI feedback, and personalized tools, mRehab helps clinicians deliver smarter, measurable care.
        </p>
      </section>
